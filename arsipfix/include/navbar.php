...
<nav class="navbar navbar-expand-lg navbar-dark bg-navbar fixed-top">
  <div class="container">
    ...
    <a class="navbar-brand mb-2" href="index.php"> E-Arsip </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link btn btn-primary text-white m-1" href="input.php">Tambah Data SPJ</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <div class="dropdown text-center mt-1">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              ...
              <a class="dropdown-item text-white mt-1 mb-1 p-2 bg-info" href="kode_rekening.php">
                <img src="img/baseline_info_white_18dp.png"> Info Kode Rekening
              </a>
              <a class="dropdown-item text-white mt-1 mb-1 p-2 bg-info" href="kegiatan.php">
                <img src="img/baseline_info_white_18dp.png"> Info Judul kegiatan
              </a>  
