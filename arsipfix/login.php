...
<html lang="en">
  ...
  <link rel="shortcut icon" type="text/css" href="img/bgbook.png">
    ...
    <div class="container mt-4 mb-3 rounded">
      <div class="row justify-content-center">
        <div class="col-lg-4 bg-white p-4 login">
          ...
          <h3 class="card-text text-center">E-ARSIP </h3>

          <div class="card text-center border-0">
            <img src="img/logo.png" class="card-img-top mx-auto">
            <div class="card-body">
              <h4 class="card-text">SEKSI PENYULUHAN SOSIAL</h4>
            </div>
          </div>
          <?php if ( isset($error)) : ?>
          ...
          <form action="" method="post">
            ...
            <br><center><p>Repost by <a href='https://dinassosial.go.id/' title='dinassosial.go.id' target='_blank'>dinassosial.go.id</a></p> </center>
            <p style=" font-family: arial; font-size: 12px; margin-top: 10%; font-weight: bold;">COPYRIGHT &copy; <?= date('Y'); ?> Seksi Penyuluhan Sosial</p>
          </form>
        </div>
      </div>
    </div>
